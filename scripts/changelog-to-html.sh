...
if [[ -z "$version_content" ]]; then
  echo "<h2>SiriClaw-Instruct $VERSION</h2>"
  echo "<p>Latest SiriClaw-Instruct update.</p>"
  echo "<p><a href=\"https://github.com/SiriClaw-Instruct/SiriClaw-Instruct/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
