...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "SiriClaw-Instruct", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for SiriClaw-Instruct. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("SiriClaw-Instruct Issue Label Audit");
