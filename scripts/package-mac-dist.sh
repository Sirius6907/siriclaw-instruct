...
#
# Output:
# - dist/SiriClaw-Instruct.app
# - dist/SiriClaw-Instruct-<version>.zip
# - dist/SiriClaw-Instruct-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.SiriClaw-Instruct.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/SiriClaw-Instruct.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SiriClaw-Instruct-$VERSION.zip"
DMG="$ROOT_DIR/dist/SiriClaw-Instruct-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SiriClaw-Instruct-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SiriClaw-Instruct-$VERSION.dSYM.zip"
