...
CDP_PORT="${SIRICLAW_BROWSER_CDP_PORT:-${SIRICLAW_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${SIRICLAW_BROWSER_CDP_SOURCE_RANGE:-${SIRICLAW_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${SIRICLAW_BROWSER_VNC_PORT:-${SIRICLAW_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${SIRICLAW_BROWSER_NOVNC_PORT:-${SIRICLAW_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${SIRICLAW_BROWSER_ENABLE_NOVNC:-${SIRICLAW_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${SIRICLAW_BROWSER_HEADLESS:-${SIRICLAW_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${SIRICLAW_BROWSER_NO_SANDBOX:-${SIRICLAW_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${SIRICLAW_BROWSER_NOVNC_PASSWORD:-${SIRICLAW_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${SIRICLAW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${SIRICLAW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${SIRICLAW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
