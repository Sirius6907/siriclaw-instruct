...
export DISPLAY=:1
export HOME=/tmp/SiriClaw-Instruct-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${SiriClaw-Instruct_BROWSER_CDP_PORT:-${SIRICLAW_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${SiriClaw-Instruct_BROWSER_CDP_SOURCE_RANGE:-${SIRICLAW_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${SiriClaw-Instruct_BROWSER_VNC_PORT:-${SIRICLAW_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${SiriClaw-Instruct_BROWSER_NOVNC_PORT:-${SIRICLAW_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${SiriClaw-Instruct_BROWSER_ENABLE_NOVNC:-${SIRICLAW_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${SiriClaw-Instruct_BROWSER_HEADLESS:-${SIRICLAW_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${SiriClaw-Instruct_BROWSER_NO_SANDBOX:-${SIRICLAW_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${SiriClaw-Instruct_BROWSER_NOVNC_PASSWORD:-${SIRICLAW_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${SiriClaw-Instruct_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${SiriClaw-Instruct_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${SiriClaw-Instruct_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
