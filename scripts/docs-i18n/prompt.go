...
- Keep product names in English: SiriClaw-Instruct, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SiriClaw-Instruct Gateway, use “Gateway 网关”.
