...
import { listDevicePairing } from "SiriClaw-Instruct/plugin-sdk/device-pair";
...
export function registerPairingNotifierService(api: SiriClaw-InstructPluginApi): void {
