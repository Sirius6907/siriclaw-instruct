import { DEFAULT_ACCOUNT_ID } from "SiriClaw-Instruct/plugin-sdk/account-id";
import {
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.SiriClaw-Instruct.ai/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: SiriClaw-InstructConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
