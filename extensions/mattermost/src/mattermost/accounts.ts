...
import { createAccountListHelpers, type SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: SiriClaw-InstructConfig): ResolvedMattermostAccount[] {
