...
import type { SiriClaw-InstructPluginApi } from "SiriClaw-Instruct/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("SiriClaw-Instruct/plugin-sdk/mattermost").SiriClaw-InstructConfig;
    runtime: import("SiriClaw-Instruct/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: SiriClaw-InstructPluginApi) {
