import type { BaseProbeResult } from "SiriClaw-Instruct/plugin-sdk/irc";
import type {
...
export type CoreConfig = SiriClaw-InstructConfig & {
  channels?: SiriClaw-InstructConfig["channels"] & {
    irc?: IrcConfig;
  };
};
