...
import type { SiriClaw-InstructPluginApi } from "SiriClaw-Instruct/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: SiriClaw-InstructPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<SiriClaw-InstructPluginApi, "config">;
