...
import { withTempDownloadPath, type ClawdbotConfig } from "SiriClaw-Instruct/plugin-sdk/feishu";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "SiriClaw-Instruct-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "SiriClaw-Instruct-feishu-resource-",
