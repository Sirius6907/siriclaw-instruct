...
import { isSecretRef } from "SiriClaw-Instruct/plugin-sdk/googlechat";
import { createAccountListHelpers, type SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: SiriClaw-InstructConfig): ResolvedGoogleChatAccount[] {
