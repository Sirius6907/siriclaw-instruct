import type { SiriClaw-InstructConfig, DmPolicy } from "SiriClaw-Instruct/plugin-sdk/googlechat";
import {
...
} from "SiriClaw-Instruct/plugin-sdk/googlechat";
import {
...
function setGoogleChatDmPolicy(cfg: SiriClaw-InstructConfig, policy: DmPolicy) {
  const allowFrom =
    policy === "open"
