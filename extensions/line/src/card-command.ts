import type { LineChannelData, SiriClaw-InstructPluginApi, ReplyPayload } from "SiriClaw-Instruct/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: SiriClaw-InstructPluginApi): void {
  api.registerCommand({
    name: "card",
