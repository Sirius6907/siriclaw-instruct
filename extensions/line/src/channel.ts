...
} from "SiriClaw-Instruct/plugin-sdk/compat";
import {
...
} from "SiriClaw-Instruct/plugin-sdk/line";
...
export const linePlugin: ChannelPlugin<ResolvedLineAccount> = {
  ...
  pairing: {
    ...
    notifyApproval: async ({ cfg, id }) => {
      ...
      await line.pushMessageLine(id, "SiriClaw-Instruct: your access has been approved.", {
  ...
  security: {
    resolveDmPolicy: ({ cfg, accountId, account }) => {
      return buildAccountScopedDmSecurityPolicy({
        ...
        approveHint: "SiriClaw-Instruct pairing approve line <code>",
  ...
  gateway: {
    ...
    logoutAccount: async ({ accountId, cfg }) => {
      ...
      const nextCfg = { ...cfg } as SiriClaw-InstructConfig;
      const lineConfig = (cfg.channels?.line ?? {}) as LineConfig;
