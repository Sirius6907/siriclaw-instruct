import type { SiriClaw-InstructConfig, PluginRuntime, ResolvedLineAccount } from "SiriClaw-Instruct/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: SiriClaw-InstructConfig; accountId: string }): Promise<{
