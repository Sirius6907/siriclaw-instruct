...
function setMSTeamsDmPolicy(cfg: SiriClaw-InstructConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: SiriClaw-InstructConfig, allowFrom: string[]): SiriClaw-InstructConfig {
