...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "SiriClaw-Instruct/plugin-sdk/msteams";
...
import { resolvePreferredSiriClaw-InstructTmpDir } from "../../../src/infra/tmp-SiriClaw-Instruct-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredSiriClaw-InstructTmpDir(), "msteams-mention-"));
