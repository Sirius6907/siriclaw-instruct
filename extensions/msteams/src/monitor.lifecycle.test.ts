...
import type { SiriClaw-InstructConfig, RuntimeEnv } from "SiriClaw-Instruct/plugin-sdk/msteams";
...
vi.mock("SiriClaw-Instruct/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): SiriClaw-InstructConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
