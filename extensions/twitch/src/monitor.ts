...
import type { ReplyPayload, SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "SiriClaw-Instruct/plugin-sdk/twitch";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // SiriClaw-InstructConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SiriClaw-InstructConfig;
