import type { SiriClaw-InstructConfig, SiriClaw-InstructPluginApi } from "SiriClaw-Instruct/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: SiriClaw-InstructConfig): { id: string; name: string } {
