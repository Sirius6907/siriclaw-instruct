import type { SiriClaw-InstructPluginConfigSchema } from "SiriClaw-Instruct/plugin-sdk/diffs";
import {
...
export const diffsPluginConfigSchema: SiriClaw-InstructPluginConfigSchema = {
