...
describe("diffs tool", () => {
  ...
  beforeEach(async () => {
    rootDir = await fs.mkdtemp(path.join(os.tmpdir(), "SiriClaw-Instruct-diffs-tool-"));
...
function createApi(): SiriClaw-InstructPluginApi {
  return {
    id: "diffs",
    name: "Diffs",
    description: "Diffs",
    ...
    runtime: {} as SiriClaw-InstructPluginApi["runtime"],
    logger: {
      info() {},
      warn() {},
      error() {},
