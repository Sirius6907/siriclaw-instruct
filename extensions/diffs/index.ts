...
import type { SiriClaw-InstructPluginApi } from "SiriClaw-Instruct/plugin-sdk/diffs";
import { resolvePreferredSiriClaw-InstructTmpDir } from "SiriClaw-Instruct/plugin-sdk/diffs";
import {
...
const plugin = {
  ...
  register(api: SiriClaw-InstructPluginApi) {
    ...
    const store = new DiffArtifactStore({
      rootDir: path.join(resolvePreferredSiriClaw-InstructTmpDir(), "SiriClaw-Instruct-diffs"),
      logger: api.logger,
    });
