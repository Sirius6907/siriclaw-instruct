...
- First public release of the @SiriClaw-Instruct/voice-call plugin.
...
- CLI: `SiriClaw-Instruct voicecall` commands (call/start/continue/speak/end/status/tail/expose).
