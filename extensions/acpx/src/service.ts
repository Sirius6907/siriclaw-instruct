import type {
  ...
  PluginLogger,
} from "SiriClaw-Instruct/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "SiriClaw-Instruct/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: SiriClaw-InstructPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: SiriClaw-InstructPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
