import type { AcpRuntime, SiriClaw-InstructPluginServiceContext } from "SiriClaw-Instruct/plugin-sdk/acpx";
...
function createServiceContext(
  overrides: Partial<SiriClaw-InstructPluginServiceContext> = {},
