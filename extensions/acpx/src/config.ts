...
import type { SiriClaw-InstructPluginConfigSchema } from "SiriClaw-Instruct/plugin-sdk/acpx";
...
export function createAcpxPluginConfigSchema(): SiriClaw-InstructPluginConfigSchema {
  return {
