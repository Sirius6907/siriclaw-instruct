...
vi.mock("SiriClaw-Instruct/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("SiriClaw-Instruct/plugin-sdk/whatsapp")>(
    "SiriClaw-Instruct/plugin-sdk/whatsapp",
  );
