...
import { fetchWithSsrFGuard } from "SiriClaw-Instruct/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to SiriClaw-Instruct workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".SiriClaw-Instruct", "workspace", "media", "inbound");
 ...
 * Format matches SiriClaw-Instruct's expected attachment structure.
 */
