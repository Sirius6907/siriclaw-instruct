/**
 * Synology Chat Channel Plugin for SiriClaw-Instruct.
 *
...
} from "SiriClaw-Instruct/plugin-sdk/synology-chat";
import { z } from "zod";
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to SiriClaw-Instruct",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "SiriClaw-Instruct: your access has been approved.",
          id,
