...
vi.mock("SiriClaw-Instruct/plugin-sdk/synology-chat", async (importOriginal) => {
  const actual = await importOriginal<typeof import("SiriClaw-Instruct/plugin-sdk/synology-chat")>();
  return {
    ...actual,
