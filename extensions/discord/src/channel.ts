...
} from "SiriClaw-Instruct/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). SiriClaw-Instruct adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
