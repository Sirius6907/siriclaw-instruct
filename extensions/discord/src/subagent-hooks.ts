import type { SiriClaw-InstructPluginApi } from "SiriClaw-Instruct/plugin-sdk/discord";
import {
...
export function registerDiscordSubagentHooks(api: SiriClaw-InstructPluginApi) {
