...
Nostr DM channel plugin for SiriClaw-Instruct using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SiriClaw-Instruct. It enables your bot to:
...
# Configure SiriClaw-Instruct to use local relay
