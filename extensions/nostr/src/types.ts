...
} from "SiriClaw-Instruct/plugin-sdk/account-id";
import type { SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: SiriClaw-InstructConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: SiriClaw-InstructConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: SiriClaw-InstructConfig): string {
