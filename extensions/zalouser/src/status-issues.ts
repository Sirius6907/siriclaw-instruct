import type { ChannelAccountSnapshot, ChannelStatusIssue } from "SiriClaw-Instruct/plugin-sdk/zalouser";
  ...
  for (const entry of accounts) {
    ...
    if (!configured) {
      issues.push({
        ...
        fix: "Run: SiriClaw-Instruct channels login --channel zalouser",
      });
      continue;
    }
