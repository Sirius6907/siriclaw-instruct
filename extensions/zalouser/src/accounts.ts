...
import { createAccountListHelpers, type SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: SiriClaw-InstructConfig, accountId: string): ZalouserAccountConfig {
