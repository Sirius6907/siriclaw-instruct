...
This directory contains the **BlueBubbles external channel plugin** for SiriClaw-Instruct.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `SiriClaw-Instruct/plugin-sdk` helpers.
