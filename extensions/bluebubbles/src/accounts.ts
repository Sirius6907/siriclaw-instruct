...
import { createAccountListHelpers, type SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: SiriClaw-InstructConfig): ResolvedBlueBubblesAccount[] {
