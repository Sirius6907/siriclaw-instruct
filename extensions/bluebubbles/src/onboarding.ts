import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "SiriClaw-Instruct/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: SiriClaw-InstructConfig, dmPolicy: DmPolicy): SiriClaw-InstructConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your SiriClaw-Instruct gateway URL + webhook path",
