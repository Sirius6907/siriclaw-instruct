...
import { resolveChannelMediaMaxBytes, type SiriClaw-InstructConfig } from "SiriClaw-Instruct/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: SiriClaw-InstructConfig; accountId?: string }): string[] {
