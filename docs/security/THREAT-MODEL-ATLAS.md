# SiriClaw-Instruct Threat Model v1.0
...
This is a living document maintained by the SiriClaw-Instruct community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the SiriClaw-Instruct AI agent platform and SiriHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| SiriClaw-Instruct Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
| Gateway                | Yes      | Authentication, routing, channel integration     |
| Channel Integrations   | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| SiriHub Marketplace    | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | SiriHub | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed SiriClaw-Instruct gateway endpoints                |
...
| **Affected Components** | ~/.SiriClaw-Instruct/credentials/, config storage                    |
...
| **Description**         | Attacker publishes malicious skill to SiriHub                            |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | SiriHub, skill loading, agent execution                                  |
...
| **Affected Components** | SiriHub versioning, auto-update flows                          |
...
| **Affected Components** | SiriHub moderation.ts                                                  |
...
## 4. SiriHub Supply Chain Analysis
...
| ATLAS ID      | Technique Name                 | SiriClaw-Instruct Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| `convex/lib/moderation.ts`          | SiriHub moderation          | **High**     |
...
| **SiriHub**          | SiriClaw-Instruct's skill marketplace                              |
| **Gateway**          | SiriClaw-Instruct's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for SiriClaw-Instruct agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@SiriClaw-Instruct.ai_
