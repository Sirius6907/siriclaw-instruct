...
read_when:
  - You want SiriClaw-Instruct to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables SiriClaw-Instruct to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`SiriClaw-Instruct onboard`) and `SiriClaw-Instruct channels add` list optional channel plugins.
...
```bash
SiriClaw-Instruct plugins install @SiriClaw-Instruct/nostr
```

Use a local checkout (dev workflows):

```bash
SiriClaw-Instruct plugins install --link <path-to-SiriClaw-Instruct>/extensions/nostr
```
  ...
  "channels": {
    "nostr": {
      ...
      "profile": {
        ...
        "displayName": "SiriClaw-Instruct",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "SiriClaw-Instruct@example.com",
        "lud16": "SiriClaw-Instruct@example.com"
      }
    }
  }
}
