...
read_when:
  ...
  - Reviewing SiriClaw-Instruct security posture
title: "Pairing"
---

# Pairing

“Pairing” is SiriClaw-Instruct’s explicit **owner approval** step.
...
Stored under `~/.SiriClaw-Instruct/credentials/`:
...
3. On your phone, open the SiriClaw-Instruct iOS app → Settings → Gateway.
...
Stored under `~/.SiriClaw-Instruct/devices/`:
...
- The legacy `node.pair.*` API (CLI: `SiriClaw-Instruct nodes pending/approve`) is a
