...
SiriClaw-Instruct treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

SiriClaw-Instruct “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, SiriClaw-Instruct can see that group and respond there.
...
Translation: allowlisted senders can trigger SiriClaw-Instruct by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@SiriClaw-Instruct", "SiriClaw-Instruct", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
