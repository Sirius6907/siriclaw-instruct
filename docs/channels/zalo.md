...
- Install via CLI: `SiriClaw-Instruct plugins install @SiriClaw-Instruct/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `SiriClaw-Instruct plugins install ./extensions/zalo`
   - From npm (if published): `SiriClaw-Instruct plugins install @SiriClaw-Instruct/zalo`
...
- Approve via:
  - `SiriClaw-Instruct pairing list zalo`
  - `SiriClaw-Instruct pairing approve zalo <CODE>`
...
- Example: `SiriClaw-Instruct message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `SiriClaw-Instruct channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `SiriClaw-Instruct logs --follow`
