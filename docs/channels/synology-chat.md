---
summary: "Synology Chat webhook setup and SiriClaw-Instruct config"
read_when:
  - Setting up Synology Chat with SiriClaw-Instruct
...
```bash
SiriClaw-Instruct plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your SiriClaw-Instruct gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in SiriClaw-Instruct.
...
- Pairing approvals work with:
  - `SiriClaw-Instruct pairing list synology-chat`
  - `SiriClaw-Instruct pairing approve synology-chat <CODE>`
...
```bash
SiriClaw-Instruct message send --channel synology-chat --target 123456 --text "Hello from SiriClaw-Instruct"
SiriClaw-Instruct message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
