...
read_when:
  - You are building a SiriClaw-Instruct plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (SiriClaw-Instruct.plugin.json)

Every plugin **must** ship a `SiriClaw-Instruct.plugin.json` file in the **plugin root**.
SiriClaw-Instruct uses this manifest to validate configuration **without executing plugin
