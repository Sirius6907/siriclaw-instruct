...
Deepgram is a speech-to-text API. In SiriClaw-Instruct it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, SiriClaw-Instruct uploads the audio file to Deepgram and injects the transcript
