...
### With SiriClaw-Instruct

You can point SiriClaw-Instruct at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SiriClaw-Instruct
...
- [Anthropic provider](/providers/anthropic) - Native SiriClaw-Instruct integration with Claude setup-token or API keys
