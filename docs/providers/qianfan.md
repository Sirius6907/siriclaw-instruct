---
summary: "Use Qianfan's unified API to access many models in SiriClaw-Instruct"
read_when:
...
3. SiriClaw-Instruct installed on your system
...
4. Copy the API key for use with SiriClaw-Instruct

## CLI setup

```bash
SiriClaw-Instruct onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SiriClaw-Instruct Configuration](/gateway/configuration)
