---
summary: "Use NVIDIA's OpenAI-compatible API in SiriClaw-Instruct"
read_when:
  - You want to use NVIDIA models in SiriClaw-Instruct
...
SiriClaw-Instruct onboard --auth-choice skip
SiriClaw-Instruct models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
