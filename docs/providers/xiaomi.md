---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SiriClaw-Instruct"
read_when:
  - You want Xiaomi MiMo models in SiriClaw-Instruct
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SiriClaw-Instruct uses
