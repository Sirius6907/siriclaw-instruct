---
summary: "Use Qwen OAuth (free tier) in SiriClaw-Instruct"
read_when:
  - You want to use Qwen with SiriClaw-Instruct
...
If you already logged in with the Qwen Code CLI, SiriClaw-Instruct will sync credentials
