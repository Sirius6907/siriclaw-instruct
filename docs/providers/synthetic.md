---
summary: "Use Synthetic's Anthropic-compatible API in SiriClaw-Instruct"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SiriClaw-Instruct registers it as the
...
Note: SiriClaw-Instruct's Anthropic client appends `/v1` to the base URL, so use
