---
summary: "Use Kilo Gateway's unified API to access many models in SiriClaw-Instruct"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in SiriClaw-Instruct
---
...
```bash
SiriClaw-Instruct onboard --kilocode-api-key <key>
```
...
SiriClaw-Instruct dynamically discovers available models from the Kilo Gateway at startup. Use
