---
summary: "Overview of SiriClaw-Instruct onboarding options and flows"
read_when:
...
SiriClaw-Instruct supports multiple onboarding paths depending on where the Gateway runs
...
- [`SiriClaw-Instruct onboard` command](/cli/onboard)

## macOS app onboarding

Use the SiriClaw-Instruct app when you want a fully guided setup on macOS. Docs:
