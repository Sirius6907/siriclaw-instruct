---
summary: "First-run onboarding flow for SiriClaw-Instruct (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SiriClaw-Instruct">
...
<Step title="CLI">
  ...
  The app can install the global `SiriClaw-Instruct` CLI via npm/pnpm so terminal
