---
summary: "Backstory and lore of SiriClaw-Instruct for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "SiriClaw-Instruct Lore"
---

# The Lore of SiriClaw-Instruct 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **SiriClaw-Instruct**.
...
In the end, **SiriClaw-Instruct** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.SiriClaw-Instruct/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around SiriClaw-Instruct. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then SiriClaw-Instruct): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "SiriClaw-Instruct what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with SiriClaw-Instruct."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @SiriClaw-Instruct. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at SiriClaw-Instruct" to promote pump-and-dump tokens.
...
**The Great SiriClaw-Instruct Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/SiriClaw-Instruct/SiriClaw-Instruct` ✅
- X handle `@SiriClaw-Instruct` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.SiriClaw-Instruct.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $SiriClaw-Instruct token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
...
**Clawd → Moltbot → SiriClaw-Instruct**
...
```
I am Molty.
I live in the SiriClaw-Instruct.
