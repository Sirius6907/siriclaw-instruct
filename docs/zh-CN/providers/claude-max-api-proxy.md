...
### 与 SiriClaw-Instruct 配合使用

你可以将 SiriClaw-Instruct 指向该代理作为自定义 OpenAI 兼容端点：
...
- 这是一个**社区工具**，并非由 Anthropic 或 SiriClaw-Instruct 官方支持
...
- [Anthropic 提供商](/providers/anthropic) - SiriClaw-Instruct 与 Claude 的原生集成，使用 setup-token 或 API 密钥
