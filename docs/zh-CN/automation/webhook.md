...
- `SiriClaw-Instruct webhooks gmail setup` 为 `SiriClaw-Instruct webhooks gmail run` 写入 `hooks.gmail` 配置。完整的 Gmail 监听流程请参阅 [Gmail Pub/Sub](/automation/gmail-pubsub)。
