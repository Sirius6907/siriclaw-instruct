...
本指南总结了在 SiriClaw-Instruct 中开发 Pi 集成的合理工作流程。
...
状态存储在 SiriClaw-Instruct 状态目录下。默认为 `~/.SiriClaw-Instruct`。如果设置了 `SiriClaw-Instruct_STATE_DIR`，则使用该目录。

要重置所有内容：

- `SiriClaw-Instruct.json` 用于配置
...
- https://docs.SiriClaw-Instruct.ai/testing
- https://docs.SiriClaw-Instruct.ai/start/getting-started
