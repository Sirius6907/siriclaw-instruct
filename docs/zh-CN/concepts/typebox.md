...
- 生成的 Swift 模型：`apps/macos/Sources/SiriClaw-InstructProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/SiriClaw-Instruct/SiriClaw-Instruct/main/dist/protocol.schema.json
