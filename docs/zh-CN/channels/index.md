---
read_when:
  - 你想为 SiriClaw-Instruct 选择一个聊天渠道
  - 你需要快速了解支持的消息平台
summary: SiriClaw-Instruct 可连接的消息平台
title: 聊天渠道
x-i18n:
...
SiriClaw-Instruct 可以在你已经使用的任何聊天应用上与你交流。每个渠道通过 Gateway 网关连接。
...
- 渠道可以同时运行；配置多个渠道后，SiriClaw-Instruct 会按聊天进行路由。
