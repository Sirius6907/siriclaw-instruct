...
All skills-related configuration lives under `skills` in `~/.SiriClaw-Instruct/SiriClaw-Instruct.json`.
...
- Keys under `entries` map to the skill name by default. If a skill defines
  `metadata.SiriClaw-Instruct.skillKey`, use that key instead.
