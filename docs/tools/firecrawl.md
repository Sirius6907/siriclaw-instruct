...
SiriClaw-Instruct can use **Firecrawl** as a fallback extractor for `web_fetch`. It is a hosted
...
SiriClaw-Instruct always uses `proxy: "auto"` plus `storeInCache: true` for Firecrawl requests.
