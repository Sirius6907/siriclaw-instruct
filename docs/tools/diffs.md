...
- Artifacts are stored under the temp subfolder: `$TMPDIR/SiriClaw-Instruct-diffs`.
...
1. `browser.executablePath` in SiriClaw-Instruct config.
2. Environment variables:
   - `SiriClaw-Instruct_BROWSER_EXECUTABLE_PATH`
