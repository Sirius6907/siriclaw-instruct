...
SiriClaw-Instruct can keep agents from getting stuck in repeated tool-call patterns.
...
When a loop is detected, SiriClaw-Instruct reports a loop event and blocks or dampens the next tool-cycle depending on severity.
