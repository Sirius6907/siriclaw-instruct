...
SiriClaw-Instruct defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, SiriClaw-Instruct inspects the OS preference (macOS/Windows)
