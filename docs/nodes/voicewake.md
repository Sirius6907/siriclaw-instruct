...
SiriClaw-Instruct treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.SiriClaw-Instruct/settings/voicewake.json`

Shape:

```json
{ "triggers": ["SiriClaw-Instruct", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
