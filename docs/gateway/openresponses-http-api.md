...
SiriClaw-Instruct’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`SiriClaw-Instruct agent`), so routing/permissions/config match your Gateway.
