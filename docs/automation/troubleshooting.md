...
SiriClaw-Instruct system heartbeat last
SiriClaw-Instruct logs --follow
SiriClaw-Instruct config get agents.defaults.heartbeat
SiriClaw-Instruct channels status --probe
```
...
```bash
SiriClaw-Instruct config get agents.defaults.heartbeat.activeHours
SiriClaw-Instruct config get agents.defaults.heartbeat.activeHours.timezone
SiriClaw-Instruct config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
SiriClaw-Instruct cron list
SiriClaw-Instruct logs --follow
```
