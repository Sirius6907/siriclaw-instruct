...
SiriClaw-Instruct ships three update channels:
...
When you **explicitly** switch channels with `--channel`, SiriClaw-Instruct also aligns
the install method:
...
When you switch channels with `SiriClaw-Instruct update`, SiriClaw-Instruct also syncs plugin sources:
