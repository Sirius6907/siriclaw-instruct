...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.SiriClaw-Instruct/SiriClaw-Instruct.json`
...
- The script prints a `MEDIA:` line for SiriClaw-Instruct to auto-attach on supported chat providers.
