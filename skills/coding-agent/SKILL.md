...
metadata:
  {
    "SiriClaw-Instruct": { "emoji": "🧩", "requires": { "anyBins": ["claude", "codex", "opencode", "pi"] } },
  }
---
...
**⚠️ CRITICAL: Never review PRs in SiriClaw-Instruct's own project folder!**
...
8. **NEVER start Codex in ~/.SiriClaw-Instruct/** - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/SiriClaw-Instruct/** - that's the LIVE SiriClaw-Instruct instance!
...
For long-running background tasks, append a wake trigger to your prompt so SiriClaw-Instruct gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
SiriClaw-Instruct system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: SiriClaw-Instruct system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
