...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.SiriClaw-Instruct/SiriClaw-Instruct.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde SiriClaw-Instruct dashboard --no-open en tu escritorio.",
    },
    insecure: {
