...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.SiriClaw-Instruct/SiriClaw-Instruct.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von SiriClaw-Instruct dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
