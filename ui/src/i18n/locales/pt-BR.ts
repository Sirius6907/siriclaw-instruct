...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.SiriClaw-Instruct/SiriClaw-Instruct.json com segurança.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando SiriClaw-Instruct dashboard --no-open no desktop.",
    },
    insecure: {
