...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Edit ~/.SiriClaw-Instruct/SiriClaw-Instruct.json safely.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from SiriClaw-Instruct dashboard --no-open on your desktop.",
    },
    insecure: {
