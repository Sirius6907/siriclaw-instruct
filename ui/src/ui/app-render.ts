...
export function renderApp(state: AppViewState) {
  const SiriClaw-InstructVersion =
      ...
      <header class="topbar">
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="SiriClaw-Instruct" />
            </div>
            <div class="brand-text">
              <div class="brand-title">SiriClaw-Instruct</div>
        ...
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${SiriClaw-InstructVersion}</span>
          </div>
          <div class="pill">
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://docs.SiriClaw-Instruct.ai"
