...
import { SiriClawInstructApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as SiriClawInstructApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as SiriClawInstructApp).resetToolStream();
  (state as unknown as SiriClawInstructApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as SiriClawInstructApp;
