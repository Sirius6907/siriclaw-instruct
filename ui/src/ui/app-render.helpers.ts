...
import { SiriClaw-InstructApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as SiriClaw-InstructApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as SiriClaw-InstructApp).resetToolStream();
  (state as unknown as SiriClaw-InstructApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as SiriClaw-InstructApp;
