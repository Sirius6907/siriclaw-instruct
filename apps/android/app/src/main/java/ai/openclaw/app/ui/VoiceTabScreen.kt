...
import ai.SiriClaw-Instruct.app.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "SiriClaw-Instruct",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("SiriClaw-Instruct is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
