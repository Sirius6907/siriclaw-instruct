...
import ai.SiriClaw-Instruct.app.ui.mobileSurface
import ai.SiriClaw-Instruct.app.ui.mobileText
import ai.SiriClaw-Instruct.app.ui.mobileTextSecondary
import ai.SiriClaw-Instruct.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.SiriClaw-Instruct.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.SiriClaw-Instruct.app.ui.mobileFontFamily,
