...
/// Menu contents for the SiriClaw-Instruct menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About SiriClaw-Instruct") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "SiriClaw-Instruct Not Configured"
        case .remote:
            "Remote SiriClaw-Instruct Active"
        case .local:
            "SiriClaw-Instruct Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .SiriClaw-InstructSelectSettingsTab, object: tab)
        }
    }
