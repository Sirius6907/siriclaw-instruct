...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SiriClaw-InstructChatMessage] = messages.compactMap { item in
