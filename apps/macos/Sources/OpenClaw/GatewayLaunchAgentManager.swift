...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".SiriClaw-Instruct/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.SiriClaw-InstructCommand(
            subcommand: "gateway",
