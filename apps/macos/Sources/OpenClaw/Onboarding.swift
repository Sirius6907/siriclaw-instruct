...
enum UIStrings {
    static let welcomeTitle = "Welcome to SiriClaw-Instruct"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "SiriClaw-Instruct.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: SiriClaw-InstructChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g SiriClaw-Instruct@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SiriClaw-InstructChatViewModel(
