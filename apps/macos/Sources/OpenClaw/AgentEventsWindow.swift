...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SiriClaw-InstructProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SiriClaw-InstructProtocol.AnyCodable("start"),
                "name": SiriClaw-InstructProtocol.AnyCodable("bash"),
            ],
            summary: nil)
