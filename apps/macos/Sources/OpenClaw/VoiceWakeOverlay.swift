...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SiriClaw-Instruct windows, but below the system’s pop-up menus.
