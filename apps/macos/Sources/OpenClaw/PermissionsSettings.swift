    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 14) {
                ...
                Text("Allow these so SiriClaw-Instruct can notify and capture when needed.")
                    .padding(.top, 4)
...
private struct LocationAccessSettings: View {
    @AppStorage(locationModeKey) private var locationModeRaw: String = SiriClaw-InstructLocationMode.off.rawValue
    ...
    private var locationMode: SiriClaw-InstructLocationMode {
        SiriClaw-InstructLocationMode(rawValue: self.locationModeRaw) ?? .off
    }

    private func requestLocationAuthorization(mode: SiriClaw-InstructLocationMode) async -> Bool {
