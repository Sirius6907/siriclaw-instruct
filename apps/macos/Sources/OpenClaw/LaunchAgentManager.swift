...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.SiriClaw-Instruct.mac.plist")
    }
    ...
    private static func writePlist(bundlePath: String) {
        ...
        <dict>
          <key>Label</key>
          <string>ai.SiriClaw-Instruct.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/SiriClaw-Instruct</string>
          </array>
