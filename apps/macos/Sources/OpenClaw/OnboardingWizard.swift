...
private let onboardingWizardLogger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between SiriClaw-InstructProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = SiriClaw-InstructProtocol.AnyCodable
