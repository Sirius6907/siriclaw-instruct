...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SiriClaw-InstructPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SiriClaw-InstructPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
