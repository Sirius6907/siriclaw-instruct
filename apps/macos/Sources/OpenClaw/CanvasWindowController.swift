...
final class CanvasWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    init(sessionKey: String, root: URL, presentation: CanvasPresentation) throws {
        ...
        (() => {
          try {
            ...
            if (globalThis.__SiriClaw-InstructA2UIBridgeInstalled) return;
            globalThis.__SiriClaw-InstructA2UIBridgeInstalled = true;
            ...
            globalThis.addEventListener('a2uiaction', (evt) => {
              try {
                ...
                const handler = globalThis.webkit?.messageHandlers?.SiriClaw-InstructCanvasA2UIAction;
                ...
                const hasBundledA2UIHost =
                  !!globalThis.SiriClaw-InstructA2UI ||
                  !!document.querySelector('SiriClaw-Instruct-a2ui-host');
                ...
                location.href = 'SiriClaw-Instruct://agent?' + params.toString();
              } catch {}
            }, true);
          } catch {}
        })();
    ...
    func snapshot(to outPath: String?) async throws -> String {
        ...
        if let outPath, !outPath.isEmpty {
            ...
            path = "/tmp/SiriClaw-Instruct-canvas-\(CanvasWindowController.sanitizeSessionKey(self.sessionKey))-\(ts).png"
        }
