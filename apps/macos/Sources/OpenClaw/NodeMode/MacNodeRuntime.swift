...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case SiriClaw-InstructBrowserCommand.proxy.rawValue:
            ...
            case SiriClaw-InstructLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case SiriClaw-InstructSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case SiriClaw-InstructSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case SiriClaw-InstructSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case SiriClaw-InstructSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case SiriClaw-InstructSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case SiriClaw-InstructCanvasA2UICommand.push.rawValue,
             SiriClaw-InstructCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard SiriClaw-InstructConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: SiriClaw-InstructNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__SiriClaw-Instruct__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(SiriClaw-InstructSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(SiriClaw-InstructSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: SiriClaw-InstructSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> SiriClaw-InstructLocationMode {
    ...
    private static func errorResponse(
        ...
        code: SiriClaw-InstructNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: SiriClaw-InstructNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: SiriClaw-InstructCanvasSnapshotFormat,
        maxWidth: Int?,
