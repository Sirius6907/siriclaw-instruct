...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SiriClaw-InstructConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - SiriClaw-Instruct Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.SiriClaw-Instruct/SiriClaw-Instruct.json
