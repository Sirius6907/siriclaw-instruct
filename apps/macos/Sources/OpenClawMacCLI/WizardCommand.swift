...
actor GatewayWizardClient {
    ...
    private func sendConnect() async throws {
        ...
        let clientId = "SiriClaw-Instruct-macos"
        let clientMode = "ui"
        let role = "operator"
        ...
        let client: [String: ProtoAnyCodable] = [
            ...
            "displayName": ProtoAnyCodable(Host.current().localizedName ?? "SiriClaw-Instruct macOS Wizard CLI"),
