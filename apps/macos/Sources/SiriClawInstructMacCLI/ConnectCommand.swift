...
struct ConnectOptions {
    ...
    var clientId: String = "SiriClaw-Instruct-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: SiriClaw-Instruct-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "SiriClaw-Instruct macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("SiriClaw-Instruct macOS Gateway Connect")
