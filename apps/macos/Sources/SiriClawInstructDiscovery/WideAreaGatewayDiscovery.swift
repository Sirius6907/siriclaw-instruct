...
enum WideAreaGatewayDiscovery {
        ...
        context: DiscoveryContext = .live) -> [WideAreaGatewayBeacon]
    {
        ...
        let probeName = "_SiriClaw-Instruct-gw._tcp.\(domainTrimmed)"
        ...
        for raw in ptrLines {
            ...
            let suffix = "._SiriClaw-Instruct-gw._tcp.\(domainTrimmed)"
    ...
    {
        guard let domain = SiriClaw-InstructBonjour.wideAreaGatewayServiceDomain else { return nil }
        let domainTrimmed = domain.trimmingCharacters(in: CharacterSet(charactersIn: "."))
        let probeName = "_SiriClaw-Instruct-gw._tcp.\(domainTrimmed)"
