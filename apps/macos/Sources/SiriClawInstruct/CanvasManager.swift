...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SiriClaw-Instruct/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__SiriClaw-Instruct__/a2ui/").absoluteString + "?platform=macos"
    }
