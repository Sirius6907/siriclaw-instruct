...
final class InstancesStore {
    ...
    private let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "instances")
    ...
    func handlePresenceEventPayload(_ payload: SiriClaw-InstructProtocol.AnyCodable) {
        do {
