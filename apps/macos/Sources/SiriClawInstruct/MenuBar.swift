...
struct SiriClaw-InstructApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "app")
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "Chat")
