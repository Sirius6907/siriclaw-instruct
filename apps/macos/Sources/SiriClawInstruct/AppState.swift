...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SiriClaw-InstructConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SiriClaw-InstructConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SiriClaw-InstructConfigFile.loadDict()
            ...
            SiriClaw-InstructConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/SiriClaw-Instruct"
        state.remoteCliPath = ""
        return state
    }
}
