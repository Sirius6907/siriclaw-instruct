...
enum SiriClaw-InstructConfigFile {
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "config")
    ...
    static func stateDirURL() -> URL {
        SiriClaw-InstructPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SiriClaw-InstructPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-SiriClaw-Instruct-config-file",
            "event": "config.write",
