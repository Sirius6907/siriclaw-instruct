...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .SiriClaw-InstructSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SiriClaw-InstructPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SiriClaw-InstructPaths.stateDirURL.path
...
extension Notification.Name {
    static let SiriClaw-InstructSelectSettingsTab = Notification.Name("SiriClaw-InstructSelectSettingsTab")
}
