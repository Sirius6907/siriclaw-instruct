...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/SiriClaw-Instruct/SiriClaw-Instruct") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/SiriClaw-Instruct/SiriClaw-Instruct")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://SiriClaw-Instruct.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SiriClaw-InstructBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SiriClaw-InstructBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SiriClaw-InstructGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SiriClaw-InstructGitCommit") as? String) ??
            "unknown"
    }
