...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SiriClaw-InstructChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SiriClaw-InstructChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
