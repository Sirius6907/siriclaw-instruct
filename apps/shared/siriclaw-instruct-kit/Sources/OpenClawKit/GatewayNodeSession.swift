...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.SiriClaw-Instruct", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SiriClaw-InstructProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
