...
public enum SiriClaw-InstructNodeStorage {
    public static func appSupportDir() throws -> URL {
        let base = FileManager().urls(for: .applicationSupportDirectory, in: .userDomainMask).first
        guard let base else {
            throw NSError(domain: "SiriClaw-InstructNodeStorage", code: 1, userInfo: [
    ...
    public static func cachesDir() throws -> URL {
        ...
        guard let base else {
            throw NSError(domain: "SiriClaw-InstructNodeStorage", code: 2, userInfo: [
