...
public enum SiriClaw-InstructKitResources {
    /// Resource bundle for SiriClaw-InstructKit.
    ///
    ...
    private static let bundleName = "SiriClaw-InstructKit_SiriClaw-InstructKit"
