...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: SiriClaw-InstructProtocol.AnyCodable]?
    {
        ...
        return [
            "id": SiriClaw-InstructProtocol.AnyCodable(identity.deviceId),
            "publicKey": SiriClaw-InstructProtocol.AnyCodable(publicKey),
            "signature": SiriClaw-InstructProtocol.AnyCodable(signature),
            "signedAt": SiriClaw-InstructProtocol.AnyCodable(signedAtMs),
            "nonce": SiriClaw-InstructProtocol.AnyCodable(nonce),
        ]
    }
}
