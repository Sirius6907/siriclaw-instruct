...
public enum SiriClaw-InstructCanvasA2UICommand: String, Codable, Sendable {
...
public struct SiriClaw-InstructCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SiriClaw-InstructCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
