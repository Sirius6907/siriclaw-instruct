...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.SiriClaw-Instruct.ios", category: "LiveActivity")
    private var currentActivity: Activity<SiriClaw-InstructActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = SiriClaw-InstructActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<SiriClaw-InstructActivityAttributes>.activities
    ...
    private func updateCurrent(state: SiriClaw-InstructActivityAttributes.ContentState) {
    ...
    private func connectingState() -> SiriClaw-InstructActivityAttributes.ContentState {
        SiriClaw-InstructActivityAttributes.ContentState(
    ...
    private func idleState() -> SiriClaw-InstructActivityAttributes.ContentState {
        SiriClaw-InstructActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> SiriClaw-InstructActivityAttributes.ContentState {
        SiriClaw-InstructActivityAttributes.ContentState(
