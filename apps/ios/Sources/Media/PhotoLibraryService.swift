...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SiriClaw-InstructPhotosLatestParams) async throws -> SiriClaw-InstructPhotosLatestPayload {
        ...
        var results: [SiriClaw-InstructPhotoPayload] = []
        ...
        return SiriClaw-InstructPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SiriClaw-InstructPhotoPayload
    {
        ...
        return SiriClaw-InstructPhotoPayload(
            format: "jpeg",
