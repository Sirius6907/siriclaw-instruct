...
final class CalendarService: CalendarServicing {
    func events(params: SiriClaw-InstructCalendarEventsParams) async throws -> SiriClaw-InstructCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            SiriClaw-InstructCalendarEventPayload(
        ...
        return SiriClaw-InstructCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: SiriClaw-InstructCalendarAddParams) async throws -> SiriClaw-InstructCalendarAddPayload {
        ...
        let payload = SiriClaw-InstructCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return SiriClaw-InstructCalendarAddPayload(event: payload)
    }
