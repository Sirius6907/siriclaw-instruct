...
/// Handles navigation policy to intercept SiriClaw-Instruct:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept SiriClaw-Instruct:// deep links.
        if url.scheme?.lowercased() == "SiriClaw-Instruct" {
