...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = SiriClaw-InstructLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = SiriClaw-InstructLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.SiriClaw-Instruct.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected SiriClaw-Instruct agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while SiriClaw-Instruct is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for SiriClaw-Instruct. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(SiriClaw-InstructLocationMode.off.rawValue)
                            Text("While Using").tag(SiriClaw-InstructLocationMode.whileUsing.rawValue)
                            Text("Always").tag(SiriClaw-InstructLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while SiriClaw-Instruct is open.")
                                ...
                                Button {
                                    self.activeFeatureHelp = FeatureHelp(
                                        ...
                                        message: "Appends this instruction when sharing content "
                                            + "into SiriClaw-Instruct from iOS."
                                    )
                                } label: {
                                    Image(systemName: "info.circle")
                                        .foregroundStyle(.secondary)
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("SiriClaw-Instruct", value: DeviceInfoHelper.SiriClaw-InstructVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = SiriClaw-InstructLocationMode(rawValue: newValue) else { return }
                Task {
