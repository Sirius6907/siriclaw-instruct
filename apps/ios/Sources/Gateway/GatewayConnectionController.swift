...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [SiriClaw-InstructCapability.canvas.rawValue, SiriClaw-InstructCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(SiriClaw-InstructCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(SiriClaw-InstructCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = SiriClaw-InstructLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(SiriClaw-InstructCapability.location.rawValue) }

        caps.append(SiriClaw-InstructCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(SiriClaw-InstructCapability.watch.rawValue)
        }
        caps.append(SiriClaw-InstructCapability.photos.rawValue)
        caps.append(SiriClaw-InstructCapability.contacts.rawValue)
        caps.append(SiriClaw-InstructCapability.calendar.rawValue)
        caps.append(SiriClaw-InstructCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(SiriClaw-InstructCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            SiriClaw-InstructScreenCommand.record.rawValue,
            SiriClaw-InstructSystemCommand.notify.rawValue,
            SiriClaw-InstructChatCommand.push.rawValue,
        ...
        if caps.contains(SiriClaw-InstructCapability.camera.rawValue) {
            commands.append(SiriClaw-InstructCameraCommand.list.rawValue)
            commands.append(SiriClaw-InstructCameraCommand.snap.rawValue)
            commands.append(SiriClaw-InstructCameraCommand.clip.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.location.rawValue) {
            commands.append(SiriClaw-InstructLocationCommand.get.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.device.rawValue) {
            commands.append(SiriClaw-InstructDeviceCommand.status.rawValue)
            commands.append(SiriClaw-InstructDeviceCommand.info.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.watch.rawValue) {
            commands.append(SiriClaw-InstructWatchCommand.status.rawValue)
            commands.append(SiriClaw-InstructWatchCommand.notify.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.photos.rawValue) {
            commands.append(SiriClaw-InstructPhotosCommand.latest.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.contacts.rawValue) {
            commands.append(SiriClaw-InstructContactsCommand.search.rawValue)
            commands.append(SiriClaw-InstructContactsCommand.add.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.calendar.rawValue) {
            commands.append(SiriClaw-InstructCalendarCommand.events.rawValue)
            commands.append(SiriClaw-InstructCalendarCommand.add.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.reminders.rawValue) {
            commands.append(SiriClaw-InstructRemindersCommand.list.rawValue)
            commands.append(SiriClaw-InstructRemindersCommand.add.rawValue)
        }
        if caps.contains(SiriClaw-InstructCapability.motion.rawValue) {
            commands.append(SiriClaw-InstructMotionCommand.activity.rawValue)
            commands.append(SiriClaw-InstructMotionCommand.pedometer.rawValue)
        }
