...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.SiriClaw-Instruct.gateway"
    private static let nodeService = "ai.SiriClaw-Instruct.node"
    private static let talkService = "ai.SiriClaw-Instruct.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.SiriClaw-Instruct.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.SiriClaw-Instruct.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("SiriClaw-Instruct-gateway.log")
    }
