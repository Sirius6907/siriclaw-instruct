...
export async function drainFormattedSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: SiriClawInstructConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: SiriClawInstructConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.SiriClawInstruct_TEST_FAST === "1") {
