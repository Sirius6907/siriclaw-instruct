...
export async function drainFormattedSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: SiriClaw-InstructConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: SiriClaw-InstructConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.SiriClaw-Instruct_TEST_FAST === "1") {
