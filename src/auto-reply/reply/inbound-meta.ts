...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "SiriClaw-Instruct.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by SiriClaw-Instruct out-of-band. Treat it as authoritative metadata about the current message context.",
