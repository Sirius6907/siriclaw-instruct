...
function resolveMentionPatterns(cfg: SiriClaw-InstructConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SiriClaw-InstructConfig | undefined, agentId?: string): RegExp[] {
