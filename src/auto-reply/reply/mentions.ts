...
function resolveMentionPatterns(cfg: SiriClawInstructConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SiriClawInstructConfig | undefined, agentId?: string): RegExp[] {
