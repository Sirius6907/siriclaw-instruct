...
import { type SiriClaw-InstructConfig, writeConfigFile } from "../../config/config.js";
...
function listAccountIds(cfg: SiriClaw-InstructConfig, channel: ChatChannel): string[] {
