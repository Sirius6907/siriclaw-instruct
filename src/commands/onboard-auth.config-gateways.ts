...
export function applyVercelAiGatewayProviderConfig(cfg: SiriClaw-InstructConfig): SiriClaw-InstructConfig {
...
export function applyVercelAiGatewayConfig(cfg: SiriClaw-InstructConfig): SiriClaw-InstructConfig {
