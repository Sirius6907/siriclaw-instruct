...
export function applyVercelAiGatewayProviderConfig(cfg: SiriClawInstructConfig): SiriClawInstructConfig {
...
export function applyVercelAiGatewayConfig(cfg: SiriClawInstructConfig): SiriClawInstructConfig {
