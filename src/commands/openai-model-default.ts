...
export function applyOpenAIProviderConfig(cfg: SiriClawInstructConfig): SiriClawInstructConfig {
...
export function applyOpenAIConfig(cfg: SiriClawInstructConfig): SiriClawInstructConfig {
