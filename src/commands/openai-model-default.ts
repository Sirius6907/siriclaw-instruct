...
export function applyOpenAIProviderConfig(cfg: SiriClaw-InstructConfig): SiriClaw-InstructConfig {
...
export function applyOpenAIConfig(cfg: SiriClaw-InstructConfig): SiriClaw-InstructConfig {
