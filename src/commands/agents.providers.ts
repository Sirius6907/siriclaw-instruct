...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SiriClawInstructConfig): boolean {
...
export function summarizeBindings(cfg: SiriClawInstructConfig, bindings: AgentBinding[]): string[] {
