...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SiriClaw-InstructConfig): boolean {
...
export function summarizeBindings(cfg: SiriClaw-InstructConfig, bindings: AgentBinding[]): string[] {
