...
export function summarizeExistingConfig(config: SiriClaw-InstructConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.SiriClaw-Instruct.ai/gateway/remote",
    "https://docs.SiriClaw-Instruct.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
