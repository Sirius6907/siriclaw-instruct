...
export function summarizeExistingConfig(config: SiriClawInstructConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.SiriClawInstruct.ai/gateway/remote",
    "https://docs.SiriClawInstruct.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
