...
export const getHandshakeTimeoutMs = () => {
  if (process.env.VITEST && process.env.SiriClawInstruct_TEST_HANDSHAKE_TIMEOUT_MS) {
    const parsed = Number(process.env.SiriClawInstruct_TEST_HANDSHAKE_TIMEOUT_MS);
