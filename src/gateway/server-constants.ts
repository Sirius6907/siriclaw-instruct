...
export const getHandshakeTimeoutMs = () => {
  if (process.env.VITEST && process.env.SiriClaw-Instruct_TEST_HANDSHAKE_TIMEOUT_MS) {
    const parsed = Number(process.env.SiriClaw-Instruct_TEST_HANDSHAKE_TIMEOUT_MS);
