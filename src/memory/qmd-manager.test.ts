...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: SiriClaw-InstructConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: SiriClaw-InstructConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__SiriClaw-InstructMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__SiriClaw-InstructMcporterColdStartWarned;
  });
