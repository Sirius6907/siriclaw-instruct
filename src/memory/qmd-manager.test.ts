...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: SiriClawInstructConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: SiriClawInstructConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__SiriClawInstructMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__SiriClawInstructMcporterColdStartWarned;
  });
