...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: SiriClaw-InstructConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: SiriClaw-InstructConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: SiriClaw-InstructConfig; accountId?: string | null }) =>
