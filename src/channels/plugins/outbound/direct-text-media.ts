...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: SiriClawInstructConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: SiriClawInstructConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: SiriClawInstructConfig; accountId?: string | null }) =>
