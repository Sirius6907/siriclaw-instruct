...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: SiriClawInstructConfig): string | undefined {
  ...
  function listAccountIds(cfg: SiriClawInstructConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SiriClawInstructConfig): string {
