...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: SiriClaw-InstructConfig): string | undefined {
  ...
  function listAccountIds(cfg: SiriClaw-InstructConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SiriClaw-InstructConfig): string {
