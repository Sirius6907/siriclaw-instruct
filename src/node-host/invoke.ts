...
const execHostEnforced = process.env.SiriClaw-Instruct_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.SiriClaw-Instruct_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
