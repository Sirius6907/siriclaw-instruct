...
const execHostEnforced = process.env.SiriClawInstruct_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.SiriClawInstruct_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
