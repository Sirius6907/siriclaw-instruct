const DEFAULT_TAGLINE = "All your chats, one SiriClawInstruct.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'SiriClawInstruct gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.SiriClawInstruct_TAGLINE_INDEX;
