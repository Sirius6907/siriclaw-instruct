const DEFAULT_TAGLINE = "All your chats, one SiriClaw-Instruct.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'SiriClaw-Instruct gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.SiriClaw-Instruct_TAGLINE_INDEX;
