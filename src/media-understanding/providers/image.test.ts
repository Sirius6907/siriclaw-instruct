...
const ensureSiriClaw-InstructModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureSiriClaw-InstructModelsJson: ensureSiriClaw-InstructModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    const result = await describeImageWithModel({
      cfg: {},
      agentDir: "/tmp/SiriClaw-Instruct-agent",
      provider: "minimax-portal",
      model: "MiniMax-VL-01",
    ...
    expect(ensureSiriClaw-InstructModelsJsonMock).toHaveBeenCalled();
