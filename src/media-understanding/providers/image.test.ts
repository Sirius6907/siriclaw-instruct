...
const ensureSiriClawInstructModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureSiriClawInstructModelsJson: ensureSiriClawInstructModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    const result = await describeImageWithModel({
      cfg: {},
      agentDir: "/tmp/SiriClawInstruct-agent",
      provider: "minimax-portal",
      model: "MiniMax-VL-01",
    ...
    expect(ensureSiriClawInstructModelsJsonMock).toHaveBeenCalled();
