...
type SiriClaw-InstructReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: SiriClaw-InstructReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSiriClaw-InstructReadTool(base, {
...
export function createSiriClaw-InstructReadTool(
  base: AnyAgentTool,
  options?: SiriClaw-InstructReadToolOptions,
): AnyAgentTool {
