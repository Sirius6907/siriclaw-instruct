...
type SiriClawInstructReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: SiriClawInstructReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSiriClawInstructReadTool(base, {
...
export function createSiriClawInstructReadTool(
  base: AnyAgentTool,
  options?: SiriClawInstructReadToolOptions,
): AnyAgentTool {
