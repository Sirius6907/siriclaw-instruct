...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    SiriClawInstruct: process.env.SiriClawInstruct_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.SiriClawInstruct === undefined) {
      delete process.env.SiriClawInstruct_GATEWAY_TOKEN;
    } else {
      process.env.SiriClawInstruct_GATEWAY_TOKEN = envSnapshot.SiriClawInstruct;
    }
  ...
  it("uses SiriClawInstruct_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.SiriClawInstruct_GATEWAY_TOKEN = "local-env-token";
