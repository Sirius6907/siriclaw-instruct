...
function pickMaxBytes(cfg?: SiriClawInstructConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  await ensureSiriClawInstructModelsJson(effectiveCfg, params.agentDir);
