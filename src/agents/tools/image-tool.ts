...
function pickMaxBytes(cfg?: SiriClaw-InstructConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  await ensureSiriClaw-InstructModelsJson(effectiveCfg, params.agentDir);
