...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): SiriClaw-InstructConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: SiriClaw-InstructConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: SiriClaw-InstructConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
