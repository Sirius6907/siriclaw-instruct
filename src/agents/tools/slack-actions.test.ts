...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): SiriClawInstructConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: SiriClawInstructConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: SiriClawInstructConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
