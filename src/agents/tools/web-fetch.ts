...
type WebFetchConfig = NonNullable<SiriClaw-InstructConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: SiriClaw-InstructConfig): WebFetchConfig {
