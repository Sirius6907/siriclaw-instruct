...
type WebFetchConfig = NonNullable<SiriClawInstructConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: SiriClawInstructConfig): WebFetchConfig {
