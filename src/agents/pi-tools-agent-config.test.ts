...
describe("Agent-specific tool filtering", () => {
  ...
  async function withApplyPatchEscapeCase(
    ...
    const workspaceDir = await fs.mkdtemp(path.join(os.tmpdir(), "SiriClaw-Instruct-pi-tools-"));
...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: SiriClaw-InstructConfig) {
    return createSiriClaw-InstructCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<SiriClaw-InstructConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<SiriClaw-InstructConfig["agents"]>["list"]>[number]["tools"];
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createSiriClaw-InstructCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createSiriClaw-InstructCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createSiriClaw-InstructCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createSiriClaw-InstructCodingTools({
      config: cfg,
    ...
    const bobTools = createSiriClaw-InstructCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createSiriClaw-InstructCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createSiriClaw-InstructCodingTools({
      config: cfg,
