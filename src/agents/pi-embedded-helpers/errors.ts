...
export function formatAssistantErrorText(
  ...
  opts?: { cfg?: SiriClawInstructConfig; sessionKey?: string; provider?: string; model?: string },
): string | undefined {
...
export function isModelNotFoundErrorMessage(raw: string): boolean {
  ...
  // Direct pattern matches from SiriClawInstruct internals and common providers.
  if (
