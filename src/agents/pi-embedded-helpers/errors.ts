...
export function formatAssistantErrorText(
  ...
  opts?: { cfg?: SiriClaw-InstructConfig; sessionKey?: string; provider?: string; model?: string },
): string | undefined {
...
export function isModelNotFoundErrorMessage(raw: string): boolean {
  ...
  // Direct pattern matches from SiriClaw-Instruct internals and common providers.
  if (
