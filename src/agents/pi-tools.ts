...
import {
  ...
  createSiriClaw-InstructReadTool,
...
function applyModelProviderToolPolicy(
  ...
  // xAI/Grok providers expose a native web_search tool; sending SiriClaw-Instruct's
...
function resolveExecConfig(params: { cfg?: SiriClaw-InstructConfig; agentId?: string }) {
...
export function createSiriClaw-InstructCodingTools(options?: {
  agentId?: string;
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      const wrapped = createSiriClaw-InstructReadTool(freshReadTool, {
        modelContextWindowTokens: options?.modelContextWindowTokens,
        imageSanitization,
      });
