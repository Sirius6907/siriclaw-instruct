...
import { resolveSiriClaw-InstructPackageRootSync } from "../../infra/SiriClaw-Instruct-root.js";
...
export function resolveBundledSkillsDir(
  ...
  const override = process.env.SiriClaw-Instruct_BUNDLED_SKILLS_DIR?.trim();
  if (override) {
    return override;
  }
