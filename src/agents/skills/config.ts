import type { SiriClaw-InstructConfig, SkillConfig } from "../../config/config.js";
import {
...
const BUNDLED_SOURCES = new Set(["SiriClaw-Instruct-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: SiriClaw-InstructConfig): string[] | undefined {
