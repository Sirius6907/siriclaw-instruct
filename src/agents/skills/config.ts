import type { SiriClawInstructConfig, SkillConfig } from "../../config/config.js";
import {
...
const BUNDLED_SOURCES = new Set(["SiriClawInstruct-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: SiriClawInstructConfig): string[] | undefined {
