...
function resolveWatchPaths(workspaceDir: string, config?: SiriClawInstructConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SiriClawInstructConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SiriClawInstructConfig }) {
