...
function resolveWatchPaths(workspaceDir: string, config?: SiriClaw-InstructConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SiriClaw-InstructConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SiriClaw-InstructConfig }) {
