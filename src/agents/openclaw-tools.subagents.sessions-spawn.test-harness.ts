...
export type CreateSiriClawInstructToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateSiriClawInstructToolsOpts) {
