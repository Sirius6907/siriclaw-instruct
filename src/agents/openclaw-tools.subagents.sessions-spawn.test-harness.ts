...
export type CreateSiriClaw-InstructToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateSiriClaw-InstructToolsOpts) {
