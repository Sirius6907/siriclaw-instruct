 ...
 *
 * SiriClaw-Instruct stores credentials in auth-profiles.json instead. This helper
 ...
 *
 * @deprecated Runtime auth now comes from SiriClaw-Instruct auth-profiles snapshots.
 */
