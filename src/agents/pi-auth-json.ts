 ...
 *
 * SiriClawInstruct stores credentials in auth-profiles.json instead. This helper
 ...
 *
 * @deprecated Runtime auth now comes from SiriClawInstruct auth-profiles snapshots.
 */
