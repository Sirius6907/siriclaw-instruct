...
const CORE_PACKAGE_NAMES = new Set(["SiriClawInstruct"]);
...
export async function resolveSiriClawInstructPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSiriClawInstructPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
