...
const CORE_PACKAGE_NAMES = new Set(["SiriClaw-Instruct"]);
...
export async function resolveSiriClaw-InstructPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSiriClaw-InstructPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
