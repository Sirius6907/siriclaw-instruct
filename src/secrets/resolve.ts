...
function resolveResolutionLimits(config: SiriClawInstructConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: SiriClawInstructConfig): SecretProviderConfig {
