...
function resolveResolutionLimits(config: SiriClaw-InstructConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: SiriClaw-InstructConfig): SecretProviderConfig {
