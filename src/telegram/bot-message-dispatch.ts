...
import type { SiriClaw-InstructConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: SiriClaw-InstructConfig, agentId: string) {
  try {
