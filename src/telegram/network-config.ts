...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SiriClaw-Instruct_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SiriClaw-Instruct_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SiriClaw-Instruct_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SiriClaw-Instruct_TELEGRAM_DNS_RESULT_ORDER
