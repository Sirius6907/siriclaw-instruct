...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SiriClawInstruct_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SiriClawInstruct_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SiriClawInstruct_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SiriClawInstruct_TELEGRAM_DNS_RESULT_ORDER
